...
#######################################################
#Group Relations for Set 5: AR: V1, V2, V5; Contemporary Connections: V2 -> V3, V2 -> V6; Lagged Connections: V1lagged -> V5, V6lagged -> V4
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    row.col<-c(14, 32, 25, 24)                        ###select group-level associations
    diag.set<-c(1, 8, 29)                             ###select AR paths 
...
dir.create('~/Dropbox (Personal)/Research Projects/CIFAR/simset5missing25')
data.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset5missing25/data'
true.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset5missing25/true'
level.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset5missing25/levels'
