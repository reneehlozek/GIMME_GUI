...
#######################################################
#Group Relations for Set 6: AR: V3, V4, V6; Contemporary Connections: V3 -> V4, V5 -> V6; Lagged Connections: V2lagged -> V3, V5lagged -> V1
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    row.col<-c(21, 35, 14, 5)                         ###select group-level associations
    diag.set<-c(15, 22, 36)                           ###select AR paths 
    #print(p.con)
    #print('p.con')
...
dir.create('/Users/reneehlozek/Dropbox/CIFAR_Sims/simset6missing100_frac30p')
data.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/simset6missing100_frac30p/data'
true.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/simset6missing100_frac30p/true'
level.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/simset6missing100_frac30p/levels'
