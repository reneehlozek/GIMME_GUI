...
#Group Relations for Set 1: AR: V3, V2, V1; Contemporary Connections: V5 -> V4, V2 -> V1; Lagged Connections: V2lagged -> V5, V1lagged -> V4
...
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    row.col<-c(23, 2, 26, 19)                         ###select group-level associations
    diag.set<-c(15, 8, 1)                             ###select AR paths 
...
dir.create('~/Dropbox (Personal)/Research Projects/CIFAR/simset2missing25')
data.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset2missing25/data'
true.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset2missing25/true'
level.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset2missing25/levels'
