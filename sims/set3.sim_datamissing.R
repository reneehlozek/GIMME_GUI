...
#Group Relations for Set 1: AR: V5, V4, V3; Contemporary Connections: V5 -> V2, V1 -> V5; Lagged Connections: V2lagged -> V4, V6lagged -> V3
...
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    row.col<-c(11, 25, 20, 18)                        ###select group-level associations
    diag.set<-c(29, 22, 15)                             ###select AR paths 
...
dir.create('~/Dropbox (Personal)/Research Projects/CIFAR/simset3missing25')
data.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset3missing25/data'
true.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset3missing25/true'
level.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset3missing25/levels'
