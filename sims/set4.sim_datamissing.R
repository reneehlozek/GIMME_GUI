...
#Group Relations for Set 1: AR: V1, V6, V5; Contemporary Connections: V3 -> V6, V4 -> V2; Lagged Connections: V4lagged -> V1, V3lagged -> V1
...
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    row.col<-c(33, 10, 4, 9)                          ###select group-level associations
    diag.set<-c(1, 36, 29)                            ###select AR paths 
...
dir.create('~/Dropbox (Personal)/Research Projects/CIFAR/simset4missing25')
data.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset4missing25/data'
true.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset4missing25/true'
level.path <- '~/Dropbox (Personal)/Research Projects/CIFAR/simset4missing25/levels'
