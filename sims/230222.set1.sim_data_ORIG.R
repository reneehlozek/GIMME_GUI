...
set.seed(seed)
#######################################################
#### 1. load functions needed to simulate the data ####s
#######################################################
...
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    row.col<-c(24, 31, 28,17)                        ###select group-level associations
...
dir.create('/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_ORIG_9Mar2026/')
data.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_ORIG_9Mar2026/data'
true.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_ORIG_9Mar2026/true'
level.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_ORIG_9Mar2026/levels'
